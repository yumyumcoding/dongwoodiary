...
class DiaryListAdapter : RecyclerView.Adapter<DiaryListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val holder = LayoutInflater.from(mContext).inflate(R.layout.activity_lst_item_diary, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (weatherType) {
            ...
            2 -> holder.iv_weather.setImageResource(R.drawable.wind)
            3 -> holder.iv_weather.setImageResource(R.drawable.rain)
            4 -> holder.iv_weather.setImageResource(R.drawable.snow)
        }
